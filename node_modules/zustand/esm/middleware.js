...
const persist = (config, options) => (set, get, api) => {
  ...
  toThenable(storage.getItem.bind(storage))(name).then((storageValue) => {
    ...
    postRehydrationCallback == null ? void 0 : postRehydrationCallback(stateFromStorageInSync, void 0);
  }).catch((e) => {
  ...
  return stateFromStorageInSync ? __spreadValues(__spreadValues({}, configResult), stateFromStorageInSync) : configResult;
};
