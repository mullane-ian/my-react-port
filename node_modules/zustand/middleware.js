...
var persist = function persist(config, options) {
  return function (set, get, api) {
    ...
    toThenable(storage.getItem.bind(storage))(name).then(function (storageValue) {
      ...
      postRehydrationCallback == null ? void 0 : postRehydrationCallback(stateFromStorageInSync, undefined);
    }).catch(function (e) {
    ...
    return stateFromStorageInSync ? _extends({}, configResult, stateFromStorageInSync) : configResult;
  };
};
