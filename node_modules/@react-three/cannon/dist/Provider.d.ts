...
export default function Provider({ children, shouldInvalidate, step, gravity, tolerance, iterations, allowSleep, broadphase, axisIndex, defaultContactMaterial, size, }: ProviderProps): JSX.Element;
