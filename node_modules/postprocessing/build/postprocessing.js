...
var POSTPROCESSING = (() => {
  ...
  var EffectComposer = class {
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      const size = this.renderer.getDrawingBufferSize(new import_three36.Vector2());
  ...
  var ChromaticAberrationEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.NORMAL, offset = new import_three41.Vector2(1e-3, 5e-4) } = {}) {
